...
public class DepartamentoTotalDTO implements Serializable {
    ...
    public DepartamentoTotalDTO(){}

    public DepartamentoTotalDTO(Departamento departamento, int quantidadePessoas, int quantidadeTarefa) {
